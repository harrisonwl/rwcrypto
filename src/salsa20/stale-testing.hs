...
-- |
-- | An infelicity of the Haskell class system for us is that instance
-- | declarations are best defined in the same module as the data type
-- | declaration itself. Placing them in separate modules makes them
-- | "orphan" instances and this will generate complaints from GHC. 
-- | ReWire doesn't include the type class system, so we can't separate,
-- | for example, a Functor declaration for X16 in Basic.hs. Basic's code
-- | *is* ReWire included throughout the Salsa20 spec. My solution is
-- | below.
...
fmap16 :: (a -> b) -> X16 a -> X16 b
fmap16 f (X16 a0 a1 a2 a3 a4 a5 a6 a7 a8 a9 aa ab ac ad ae af)
     = X16 (f a0) (f a1) (f a2) (f a3) (f a4) (f a5) (f a6) (f a7) (f a8) (f a9) (f aa) (f ab) (f ac) (f ad) (f ae) (f af)


fmap64 :: (a -> b) -> X64 a -> X64 b
fmap64 f (X64 a00 a01 a02 a03 a10 a11 a12 a13 a20 a21 a22 a23 a30 a31 a32 a33
...
x16 a0 a1 a2 a3 a4 a5 a6 a7 a8 a9 aa ab ac ad ae af = fmap16 ReWire.Bits.lit (X16 a0 a1 a2 a3 a4 a5 a6 a7 a8 a9 aa ab ac ad ae af)
...
x64 a00 a01 a02 a03 a10 a11 a12 a13 a20 a21 a22 a23 a30 a31 a32 a33
    ...
    a80 a81 a82 a83 a90 a91 a92 a93 aa0 aa1 aa2 aa3 ab0 ab1 ab2 ab3
    ac0 ac1 ac2 ac3 ad0 ad1 ad2 ad3 ae0 ae1 ae2 ae3 af0 af1 af2 af3
     = fmap64 ReWire.Bits.lit (X64 a00 a01 a02 a03 a10 a11 a12 a13 a20 a21 a22 a23 a30 a31 a32 a33
                                 a40 a41 a42 a43 a50 a51 a52 a53 a60 a61 a62 a63 a70 a71 a72 a73
                                 a80 a81 a82 a83 a90 a91 a92 a93 aa0 aa1 aa2 aa3 ab0 ab1 ab2 ab3
                                 ac0 ac1 ac2 ac3 ad0 ad1 ad2 ad3 ae0 ae1 ae2 ae3 af0 af1 af2 af3)
