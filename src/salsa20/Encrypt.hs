...
encode64 :: Hex (W 8) -> Hex (W 8) -> Oct (W 8) -> [W 8] -> W 64 -> [W 8]
encode64 k0 k1 v [] _        = []
encode64 k0 k1 v (mi : ms) i = (mi ^ ((salsa20_k0k1 (k0 , k1) (splice v (factor64 i))) `pi64` (mod64 i))) : encode64 k0 k1 v ms (i ReWire.Bits.+ lit 1)

encrypt64 :: String -> [W 8]
encrypt64 plaintext = encode64 k0 k1 v m (lit 0)
  where
     m :: [W 8]
